...
Please refer to the file `Action categories and Appendix of capture settings.pdf` for more detail about the action categories description both in English and Chinese . Before using this database, please make sure you have read `License Agreement.docx` yet.
